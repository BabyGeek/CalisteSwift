...
public enum Routine {
    ...
    /// Every Minute On the Minute routine, 
    /// where exercises are performed at the start of each minute for a set duration.
    case EMOM

    /// High-Intensity Interval Training, involving short bursts of intense exercise 
    /// followed by rest or low-intensity periods.
    case HIIT
    ...
    /// A routine focused on building strength through exercises that target 
    /// specific muscle groups with higher resistance.
    case strength
    ...
    /// A routine designed for recovery, including light exercises or 
    /// activities to help the body recover and reduce muscle soreness.
    case recovery
}
